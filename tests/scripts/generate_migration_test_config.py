...
async def generate_migration_yaml():
    ...
    try:
        ...
        # Phase 2: Generate panel sensors
        print("⚙️ Phase 2: Generating panel sensors...")
        try:
            ...
            global_settings = {
                "device_identifier": harness.device_identifier,
                "variables": {"energy_grace_period_minutes": "15"}
            }
        
        # Phase 3: Generate circuit sensors
        print("🔌 Phase 3: Generating circuit sensors...")
        try:
        ...
        # Phase 4: Combine all sensor configs
        print("📊 Phase 4: Combining sensor configurations...")
        ...
        # Phase 5: Generate YAML using the integration's code path
        print("🔨 Phase 5: Generating YAML using integration's code path...")
        try:
            ...
            print(f"   ❌ Failed to use integration YAML generation, falling back: {e}")
            complete_yaml_dict = {
                "version": "1.0",
        ...
        with open(summary_file, 'w', encoding='utf-8') as f:
            ...
            circuit_names = [k for k in circuit_sensor_configs.keys() if "_power" in k][:10]
        ...
        return yaml_content, all_sensor_configs, validation_success
...
if __name__ == "__main__":
    ...
    if yaml_content and validation_success:
        ...
        print("\n⚠️ Migration test completed with validation issues!")

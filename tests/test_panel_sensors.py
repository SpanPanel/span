...
class TestPanelSensors:
    ...
    def test_dsm_state_sensor(self, mock_coordinator, mock_span_panel):
        ...
        # Test with different DSM states
        test_states = ["NORMAL", "BACKUP", "GRID_TIE", "UNKNOWN"]
    ...
    def test_current_run_config_sensor(self, mock_coordinator, mock_span_panel):
        ...
        # Test with different run configs
        test_configs = ["GRID_TIE", "BACKUP", "SELF_SUPPLY", "PRIORITY_BACKUP"]

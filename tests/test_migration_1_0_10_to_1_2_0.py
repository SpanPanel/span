...
async def test_migration_1_0_10_to_1_2_0():  # noqa: C901
    ...
    registry_source = Path(__file__).parent / "migration_storage" / "1_0_10" / "core.entity_registry"
...
sensors:"""
  ...
  "{unique_id}":
    ...
    if success:
        ...
        print("   Ready for v1.0.10 → v1.2.0 migration!")
    else:
